...
public class PopularCategoryPanel extends JPanel{
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Create the panel
            PopularCategoryPanel popularCategoryPanel = new PopularCategoryPanel(jollibeeImage, titleLabel,
                    ratingLabel, deliveryTimeLabel, distanceLabel);

            // Create the frame and add the panel
            JFrame frame = new JFrame("Test Frame");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.getContentPane().add(popularCategoryPanel);
            frame.pack();
