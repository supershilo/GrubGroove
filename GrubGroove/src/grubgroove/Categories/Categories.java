...
public class Categories extends JFrame{
    ...
    BasicCategory jollibeeFFPanel, mcdoPanel, kfcPanel, MangInasalPanel;
    BasicCategory americanPanel, japanesePanel, koreanPanel, chinesePanel;
    BasicCategory bakeryPanel, iceCreamPanel, beveragePanel, healthyPanel;
    ...
    public Categories() {
        ...
        jollibeeFFPanel = new BasicCategory(jollibeeFFImage, jollibeFFLabel);
        jollibeePanel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
        ...
        mcdoPanel = new BasicCategory(mcdoImage, mdcoLabel);
        ...
        kfcPanel = new BasicCategory(kfcImage, kfcLabel);
        ...
        MangInasalPanel = new BasicCategory(mangInasalIimage, mangInasalLabel);
        ...
        americanPanel = new BasicCategory(americanFImage, americanLabel);
        ...
        koreanPanel = new BasicCategory(koreanImage, koreanLabel);
        ...
        chinesePanel = new BasicCategory(chineseImage, chineseLabel);
        ...
        japanesePanel = new BasicCategory(japaneseImage, japaneseLabel);
        ...
        bakeryPanel = new BasicCategory(bakeryImage, bakeryLabel);
        ...
        iceCreamPanel = new BasicCategory(iceCreamImage, iceCreamLabel);
        ...
        beveragePanel = new BasicCategory(beverageImage, beverageLabel);
        ...
        healthyPanel = new BasicCategory(healthyImage, healthyLabel);
