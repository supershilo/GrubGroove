...
public class BasicCategory extends JPanel{
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Create the panel
            BasicCategory basicCategoryPanel = new BasicCategory(jollibeeImage, titleLabel);
    ...
    public BasicCategory(JLabel header, JLabel title) {
